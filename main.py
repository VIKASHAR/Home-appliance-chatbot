...
st.set_page_config(page_title="Home Appliance review Chatbot", layout="wide")
...
def main():
    ...
    user_question = st.text_input("Ask a Question (e.g., 'What is the review of Havells Cista Room Heater')", key="user_question")
